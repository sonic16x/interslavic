...
import {
    _getConjugationVerbFlat as getConjugationVerbFlat,
    _getDeclensionAdjectiveFlat as getDeclensionAdjectiveFlat,
    _getDeclensionNounFlat as getDeclensionNounFlat,
    _getDeclensionNumeralFlat as getDeclensionNumeralFlat,
    _getDeclensionPronounFlat as getDeclensionPronounFlat,
    conjugationVerb,
    declensionAdjective,
    declensionNoun,
    declensionNumeral,
...
class TranslatorClass {
    ...
    private getWordForm(
        ...
        switch (translatedPos) {
            case 'noun': {
                ...
                const animated = isAnimate(details)
    ...
    public formatNodes(nodes: ITranslateNode[], flavorisationType, alphabet): ITranslateNode[] {
        return nodes.map((item) => ({
            ...item,
            str:
                (item.type === 'valid' || item.type === 'maybe') ?
                    this.format(item.str, flavorisationType, alphabet) : item.str,
